    ...
    <div className="min-h-screen bg-brown-950 flex overflow-x-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 h-screen relative flex-col items-center justify-center p-8 overflow-hidden text-center">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          {/* Tagline */}
          <h2 className="text-3xl font-bold text-brown-50 mb-0.5">Trade Smarter.</h2>
          <h2 className="text-3xl font-bold text-gold-400 mb-4">Not Harder.</h2>
            ...
            {features.map((feature) => {
              ...
              return (
                <div key={feature.title} className="flex items-center gap-3">
                  <div className="p-2 bg-gold-400/10 rounded-lg border border-gold-400/20">
                    <Icon className="w-4 h-4 text-gold-400" />
                  </div>
                  <div>
                    <p className="text-brown-100 font-medium text-sm">{feature.title}</p>
                    <p className="text-brown-500 text-xs">{feature.description}</p>
                  </div>
                </div>
              );
            })}
          ...
          {/* Trust badges */}
          <div className="flex items-center gap-6 mt-6 pt-4 border-t border-brown-800/50">

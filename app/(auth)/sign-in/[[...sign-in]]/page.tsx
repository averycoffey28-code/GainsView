      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-6 sm:p-8 lg:p-12 relative z-10">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-6 lg:mb-8">
            <h2 className="text-2xl font-bold text-brown-50 mb-2">Welcome back</h2>
            <p className="text-brown-400">Sign in to access your trading dashboard</p>
          </div>
        ...
        <div className="lg:hidden mt-10 w-full max-w-md">
